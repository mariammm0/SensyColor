...
Commencez par vous inscrire si c'est la première fois sur notre site.
Vous avez ensuite trois boutons : celui pour capter des couleurs, celui pour voir/créer vos palettes et celui pour voir l'historique de vos couleurs captées.
Vous trouverez en haut à gauche un bouton pour revenir au menu, et un bouton en haut à droite pour vous déconnecter.
